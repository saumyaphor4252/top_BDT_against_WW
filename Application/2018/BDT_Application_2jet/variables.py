...
#     'range' : ([-0.50,-0.25,-0.15,0.,0.15,0.25,0.35,0.50,0.80],),
     ...
     'fold' : 3,
     'linesToAdd' : ['.L /afs/cern.ch/user/s/ssaumya/Projects/WW_Analysis_Work/WW_Cuts_Optimization/CMSSW_11_1_3/src/PlotsConfigurations/Configurations/WW/FullRunII/Full2018_v7/BDT_Application_2j/WW_against_top_bg_2j.C+']
