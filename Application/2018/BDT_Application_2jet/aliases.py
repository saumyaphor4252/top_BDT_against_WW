...
configurations = os.path.dirname(configurations) # inclusive BDT Application 2j
configurations = os.path.dirname(configurations) # 2018 v7
configurations = os.path.dirname(configurations) # FullRun II
